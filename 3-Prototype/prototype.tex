...
With the appropriate permissions, assets may be changed directly, without facilitating \textcolor{red}{[It is not clear to me what you mean by `facilitating', here]} any of the mentioned transactions in order to administer them. Therefore, regardless of how the assets are changed (i.e.\ using custom transactions or just executing changes directly), all manipulations to the chain are recorded to the chain and clearly traceable.
