...
In figure [TODO: ref simple net] the current working environment is shown. It is utilising the possibilities hyperledger fabric is offering. When looking further into detail the following main components can be singled out:
...
\todo{add simple network figure}

\todo{add extended network figure}
