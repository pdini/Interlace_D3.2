...
\textbf{Run fabric blockchain (the first time)}
...
Those cards provide all information needed to connect to the INTERLACE blockchain business network. In particular there have been installed two cards:
