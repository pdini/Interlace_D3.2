...
In figure \label{fig:webapp} an illustration of a web page generated for the INTERLACE business network implementation is shown. It has been created using generator-hyperledger-composer\footnote{\url{https://www.npmjs.com/package/generator-hyperledger-composer}} which is a yeoman\footnote{\url{http://yeoman.io/}} module.
